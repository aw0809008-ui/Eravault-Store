            ...
            <div className="md:w-[42%] md:overflow-y-auto md:max-h-[94vh] bg-white">
              <div className="p-5 sm:p-8 space-y-4 sm:space-y-5 pb-8">
                ...
                <div className="space-y-2.5">
                  <a href={wu} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-2.5 w-full py-3.5 sm:py-4 bg-gradient-to-r from-[#25D366] to-[#128C7E] text-white font-bold rounded-2xl transition-all duration-200 hover:shadow-xl hover:shadow-[#25D366]/30 active:scale-[0.98] text-sm sm:text-base">
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    <a href={eu} className="flex items-center justify-center gap-1.5 py-2.5 sm:py-3 bg-brand-50 hover:bg-brand-100 text-brand-800 font-semibold rounded-xl transition-all border border-brand-200 text-xs sm:text-sm active:scale-[0.98]">
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>Email
                    </a>
                    <a href="https://instagram.com/Eravault_vintage" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1.5 py-2.5 sm:py-3 bg-gradient-to-r from-[#833AB4]/10 to-[#E1306C]/10 text-[#E1306C] font-semibold rounded-xl transition-all border border-[#E1306C]/20 text-xs sm:text-sm active:scale-[0.98]">
                      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069z"/><circle cx="12" cy="12" r="3.5"/></svg>Instagram
                    </a>
                  </div>
                  <p className="text-center text-[11px] text-brand-400 pt-0.5">📞 +92 323 8226427 &nbsp;•&nbsp; eravaultvintage@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
